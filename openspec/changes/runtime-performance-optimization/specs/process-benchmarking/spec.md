...
Benchmark artifacts SHALL preserve enough runtime-stability context to explain why a run changed in cost or capability, including cache usage, degraded-mode activation, major gating decisions, and warm-vs-cold AI execution context when available.
