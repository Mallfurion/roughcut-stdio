# standalone-desktop-runtime Specification

## Purpose
Define the packaged Roughcut Stdio desktop runtime so the app can run, store state, and bootstrap local assets without depending on a repository checkout.
